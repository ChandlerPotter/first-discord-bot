/**
 * Definitions By: NotMarx <notmarx.tech@gmail.com>
 */
...
class Random {
  ...
  async getAnimeImgURL(action) {
    let array = ["pat", "hug", "waifu", "cry", "kiss", "slap", "smug", "punch", "kitsune", "nekolewd"];

    if (!array.find(x => x === action.toLowerCase())) {
      return console.log(
        "Unknown Action name, options of action are - " + array.join(", ") + "Need Help? Check: https://discord.gg/78RyqJK"
      );
    }
